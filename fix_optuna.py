...
"""
    ...
    # Using specific index or stricter matching to avoid replacing Cell 12 with Cell 25 logic
    if i == 12:
...
"""
    ...
    if i == 27 and 'optimizer = optim.Adam' in src:
        new_src = src.replace(
...
print(f"[OK] Successfully FIXED and applied Optuna to {out_file}")
